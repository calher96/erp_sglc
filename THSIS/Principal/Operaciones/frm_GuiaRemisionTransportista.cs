...
namespace Principal.Operaciones
{
    public partial class frm_GuiaRemisionTransportista : Form
    {
        ...
        {
            cbo_Cliente.SelectedItem = Carga.ClientePago;
            cbo_ClienteRemitente.SelectedItem = Carga.ClienteRemitente;
            cbo_ClienteDestinatario.SelectedItem = Carga.ClienteDestinatario;
