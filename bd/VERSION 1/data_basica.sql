INSERT INTO DEV.EMPRESA (empr_RazonSocial, empr_NroDocumento, empr_Logo)
VALUES('EMPRESA DE TRANSPORTES LOGISTICOS', '20123456789', '');--INSERTAR EMPRESA
INSERT INTO DEV.SUCURSAL (empr_Id, sucu_Direccion, sucu_CodSunat, sucu_Nombre)
VALUES(2, 'CHICLAYO', '1024568793', 'CENTRAL CHICLAYO');-- INSERTAR SUCURSAL
INSERT INTO DEV.TRABAJADOR (trab_TipoDocumento, trab_Documento, trab_Nombres, trab_ApellidoPaterno, trab_ApellidoMaterno, trab_EstadoCivil,
trab_Estado, trab_Marcabaja, trab_FechaNacimiento, trab_FechaRegistro, trab_UsuarioRegistro, empr_Id)
VALUES(1,'76577148', 'CARLOS ALBERTO', 'HERNANDEZ', 'HERNANDEZ', 1, 1, 1, '1996/06/05', '2023/04/19', 'CHERNANDEZ', 2);--INSERTAR TRABAAJDOR
INSERT INTO DEV.USUARIO (usua_Usuario, usua_Password, usua_Estado, usua_Marcabaja, trab_Id, usua_FechaAlta, usua_FechaRegistro,
usua_UsuarioRegistro, sucu_Id)
VALUES('CHERNANDEZ', (SELECT ENCRYPTBYPASSPHRASE('erp_sglc','carlos561996')), 1, 1, 2, '2023/04/19', '2023/04/19', 'INIT',2);--INSERTAR USUARIO
INSERT INTO DEV.AREA (area_Nombre, empr_Id)
VALUES('ADMINISTRACIÓN', 2),
('OPERACIONES',2);
INSERT INTO DEV.CONCEPTO (conc_Prefijo, conc_Correlativo, conc_Descripcion, conc_Abreviatura)
VALUES(1,0, 'TIPO DE DOCUMENTO', 'TDOC'),
(1,1, 'DNI', '1'),
(1,2, 'RUC', '6'),
(2,0, 'ESTADO CIVIL', 'ECIV'),
(2,1, 'SOLTERO', 'SOLT'),
(2,2, 'CASADO', 'TDOC'),
(2,3, 'VIUDO', 'VIUD'),
(2,4, 'DIVORCIADO', 'DIVO'),
(2,5, 'CONVIVIENTE', 'CONV'),
(3,0, 'CATEGORIA TRABAJADOR', 'CATT'),
(3,1, 'TRABAJADOR', 'TRAB'),
(3,2, 'PENSIONISTA', 'PENS'),
(3,3, 'PERSONAL EN FORMACIÓN L', 'PFOR'),
(3,4, 'PERSONAL DE TERCEROS', 'PTER'),
(3,5, 'OTROS', 'OTRO'),
(4,0, 'ESTADO TRABAJADOR', 'ETRA'),
(4,1, 'BAJA (1)', 'BAJA'),
(4,2, 'ACTIVO O SUBSIDIADO (1)', 'SUBS'),
(4,3, 'SIN VÍNCULO LABORAL CON CONCEPTOS PENDIENTES', 'SVIN'),
(4,4, 'SUSPENSIÓN PERFECTA DE LABORES (3)', 'SUSP'),
(5,0, 'PUESTO EN VEHÍCULO', 'SUSP'),
(5,1, 'NINGUNO', 'SUSP'),
(5,2, 'PILOTO', 'SUSP'),
(5,3, 'COPILOTO', 'SUSP'),
(5,4, 'AYUDANTE', 'SUSP'),
(5,5, 'PILOTO - COPILOTO', 'SUSP'),
(5,6, 'COPILOTO - AYUDANTE', 'SUSP'),
(6,0, 'GRADO DE INSTRUCCIÓN', 'GINS'),
(6,1, 'SIN EDUCACIÓN FORMAL', 'GINS'),
(6,2, 'EDUCACIÓN ESPECIAL INCOMPLETA', 'GINS'),
(6,3, 'EDUCACIÓN ESPECIAL COMPLETA', 'GINS'),
(6,4, 'EDUCACIÓN PRIMARIA INCOMPLETA', 'GINS'),
(6,5, 'EDUCACIÓN PRIMARIA COMPLETA', 'GINS'),
(6,6, 'EDUCACIÓN SECUNDARIA INCOMPLETA', 'GINS'),
(6,7, 'EDUCACIÓN SECUNDARIA COMPLETA', 'GINS'),
(6,8, 'EDUCACIÓN TÉCNICA INCOMPLETA', 'GINS'),
(6,9, 'EDUCACIÓN TÉCNICA COMPLETA', 'GINS'),
(6,10, 'EDUCACIÓN SUPERARIOR (INSTUTUTO SUPERIOR, ETC) INCOMPLETA', 'GINS'),
(6,11, 'EDUCACIÓN SUPERARIOR (INSTUTUTO SUPERIOR, ETC) COMPLETA', 'GINS'),
(6,12, 'EDUCACIÓN UNIVERSITARIA INCOMPLETA', 'GINS'),
(6,13, 'EDUCACIÓN UNIVERSITARIA COMPLETA', 'GINS'),
(6,14, 'GRADO BACHILLER', 'GINS'),
(6,15, 'TITULADO', 'GINS'),
(6,16, 'ESTUDIOS DE MAESTRÍA INCOMPLETA', 'GINS'),
(6,17, 'ESTUDIOS DE MAESTRÍA COMPLETA', 'GINS'),
(6,18, 'GRADO DE MAESTRÍA', 'GINS'),
(6,19, 'ESTUDIOS DE DOCTORADO INCOMPLETO', 'GINS'),
(6,20, 'ESTUDIOS DE DOCTORADO COMPLETO', 'GINS'),
(6,21, 'GRADO DE DOCTOR', 'GINS'),
(7,0,'SEXO', 'SEXO'),
(7,1,'MASCULINO', 'MASC'),
(7,2,'FEMENINO', 'FEMN'),
(8,0,'MARCABAJA', 'MCBJ')
(8,1,'ACTIVO', 'ACTV'),
(8,2,'ELIMINADO', 'ELIM'),
(9,0,'RELACION LABORAL', 'RELA'),
(9,1,'CONTRATO A PLAZO FIJO', 'PFIJ'),
(9,2,'CONTRATO DE PRACTICAS PROFESIONALES', 'PRAC'),
(9,3,'CONTRATO INDETERMINADO', 'INDE'),
(9,4,'LOCACION DE SERVICIOS', 'LOSE'),
(10,0,'TIPO DE PERSONA', 'TPER'),
(10,1,'PERSONA NATURAL', 'PNAT'),
(10,2,'PERSONA JURÍDICA', 'PJUR');
GO

INSERT INTO DEV.DEPARTAMENTO (dept_Ubigeo, dept_Descripcion) VALUES
('01','AMAZONAS'),
('02','ANCASH'),
('03','APURIMAC'),
('04','AREQUIPA'),
...
INSERT INTO DEV.PROVINCIA (prov_Ubigeo, prov_Descripcion, dept_Ubigeo) VALUES
('0101','CHACHAPOYAS','01'),
('0102','BAGUA','01'),
('0103','BONGARA','01'),
...
('2401','TUMBES','24');
GO
INSERT INTO DEV.DISTRITO (dist_Ubigeo, dist_Descripcion, prov_Ubigeo) VALUES
...
('030220','JOSE MARIA ARGUEDAS','0302'),
...
('050512','UNION PROGRESO','0505'),
('050513','RIO MAGDALENA','0505'),
('050514','NINABAMBA','0505'),
('050515','PATIBAMBA','0505'),
('050601','PUQUIO','0506'),
('050602','AUCARA','0506'),
('050603','CABANA','0506'),
...
('080915','KUMPIRUSHIATO','0809'),
('080916','CIELO PUNCO','0809'),
('080917','MANITEA','0809'),
('080918','UNION ASHÁNINKA','0809'),
('081001','PARURO','0810'),
('081002','ACCHA','0810'),
('081003','CCAPI','0810'),
('081004','COLCHA','0810'),
...
('150144','SANTA MARIA DE HUACHIPA','1501'),
...
('230109','SAMA','2301'),
('230110','CORONEL GREGORIO ALBARRACIN LANCHIP','2301'),
